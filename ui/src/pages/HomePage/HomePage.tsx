...
import {Card, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Typography} from "@mui/material";
...
const Cart = () => {
    ...
    useEffect(() => {
        ...
        BucketService.getSumProductInBucket().then(sumProducts => setSumProducts(sumProducts.sum));
    }, []);
